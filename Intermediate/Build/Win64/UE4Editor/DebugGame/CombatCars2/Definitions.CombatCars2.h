...
#define ORIGINAL_FILE_NAME "UE4Editor-CombatCars2-Win64-DebugGame.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 1
#define UE_PROJECT_NAME CombatCars2
#define HMD_MODULE_INCLUDED 1
#define DEPRECATED_FORGAME DEPRECATED
#define HMD_MODULE_INCLUDED 1
#define COMBATCARS2_API DLLEXPORT
